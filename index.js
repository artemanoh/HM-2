...
const healthPlayer = 65;
const energyPlayer = 55;
console.log(healthPlayer - 33);
console.log(energyPlayer - 14);
...
const stringOfFloat = "35.2347";
console.log(Number.parseFloat(stringOfFloat));

const stringOfInt = "213";
console.log(Number.parseFloat(stringOfInt));
...
console.log(stringOfNumbers.toString());
